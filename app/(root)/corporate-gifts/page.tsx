...
export default function CorporateGiftsPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert('Thank you! Our corporate team will contact you within 24 hours.');
    setFormData({
      companyName: '',
      contactName: '',
      email: '',
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-16 bg-gradient-to-br from-gray-50 to-white p-8 md:p-12 rounded-lg border border-gray-200">
            ...
            <form onSubmit={handleSubmit} className="max-w-3xl mx-auto space-y-6">
              ...
              <div className="text-center">
                <button
                  type="submit"
                  className="bg-orange-600 text-white px-12 py-4 rounded-full text-lg font-semibold hover:bg-orange-700 transition-colors shadow-lg hover:shadow-xl"
                >
                  Request Quote
                </button>
              </div>
          ...
          <div className="bg-gradient-to-r from-orange-500 to-orange-600 p-8 rounded-lg text-white text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <a 
                href="mailto:corporate@licoriceropes.com" 
