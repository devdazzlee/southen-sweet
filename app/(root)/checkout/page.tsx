  ...
  const calculateShipping = async () => {
    ...
    try {
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5000/api'}/shippo/calculate-rates`,
        {
          shippingAddress: {
            name: address.name,
            email: address.email,
  ...
  const handleProceedToPayment = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5000/api'}/payment/create-checkout-session`,
        {
          method: 'POST',
          credentials: 'include',
      ...
      <div className="min-h-screen bg-gray-50 pt-32 sm:pt-36 md:pt-40 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-4 px-4">Your cart is empty</h2>
            <p className="text-sm sm:text-base text-gray-600 mb-8 px-4">Add some items to your cart before checking out.</p>
            <button
              ...
              <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-2">
                  <div className="flex items-center gap-3">
                    ...
                    <h2 className="text-lg sm:text-xl font-semibold">Review Your Cart</h2>
                  </div>
            ...
            {currentStep === 3 && (
              <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-lg sm:text-xl font-semibold">Shipping Method</h2>
                </div>
                    ...
                    >
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                        ...
                        <div className="text-left sm:text-right pl-7 sm:pl-0">
                          <p className="text-base sm:text-lg font-semibold text-gray-900">${rate.amount.toFixed(2)}</p>
                        </div>
                      </div>
                    </div>
                  ))}
              ...
              {selectedRate && (
                <div className="mt-4 p-3 bg-green-50 border border-green-200 rounded-lg flex items-start gap-2">
                  ...
                  <div className="text-sm">
                    <p className="font-medium text-green-900">Shipping calculated</p>
